...
$.fn.gldfn = function() {
    ...
    $('[class*="mt-"]').each(function() {
        ...
        a.test(d) || (d = ""), a.test(c) || (c = ""), $(this).css({
            "margin-top": b + c + d + "px"
        })
...
/*! jQuery Validation Plugin - v1.17.0 - 7/29/2017 https://jqueryvalidation.org/ Copyright (c) 2017 J̦rn Zaefferer; Licensed MIT */
! function(a) {
        ...
        return this.each(function() {
            ...
            function s(e) {
                ...
                0 > h && (h += 360), i.css({
                    ...
                    transform: "rotateY(" + v + "deg) rotateX(" + c + "deg) scale(1.04)"
